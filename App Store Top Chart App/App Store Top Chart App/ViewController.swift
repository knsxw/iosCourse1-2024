...
//
//  Created by Sasori on 18/7/2567 BE.
//
...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let appPage = UIStoryboard(name: "Main", bundle: .main).instantiateViewController(withIdentifier: "appPage") as! AppViewController
        appPage.appInfo = topTenApps[indexPath.row]
        navigationController?.pushViewController(appPage, animated: true)
    }
